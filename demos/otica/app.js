(function(){
  "use strict";
  var WA = '5511955550000';
  var BASE = "https://wa.me/" + WA + "?text=";
  var SHOP = 'Ótica Lume';
  var PRODUCTS = [
    { id:'round', name:'Redondo acetato', cat:'grau', price:420, desc:'Haste flex, ponte confortável. Vários tons.', img:'img/p1.jpg', tag:'Grau' },
    { id:'aviator', name:'Aviator clássico', cat:'solar', price:380, desc:'Lente UV400. Estilo atemporal.', img:'img/p2.jpg', tag:'Solar' },
    { id:'way', name:'Wayfarer fosco', cat:'solar', price:350, desc:'Acetato fosco, lente polarizada (demo).', img:'img/p3.jpg', tag:'Solar' },
    { id:'cat', name:'Gatinho metal', cat:'grau', price:460, desc:'Leve, aros finos. Boa p/ rostos ovais.', img:'img/p4.jpg', tag:'Grau' },
    { id:'modern', name:'Quadrado moderno', cat:'grau', price:490, desc:'Geometria limpa, ponte reforçada.', img:'img/p5.jpg', tag:'Grau' },
    { id:'sport', name:'Esportivo wrap', cat:'solar', price:410, desc:'Maior cobertura, grip nas hastes.', img:'img/p6.jpg', tag:'Solar' },
    { id:'hero', name:'Curadoria da vitrine', cat:'grau', price:450, desc:'Destaques da semana — pergunte medidas.', img:'img/hero.jpg', tag:'Vitrine' }
  ];
  var CATS = ['todas', 'grau', 'solar', 'acessorios'];
  var LABELS = {'todas': 'Tudo', 'grau': 'Grau', 'solar': 'Solar', 'acessorios': 'Acessórios'};
